...
+ (NSString *)localizedString:(NSString *)key {
    ...
    NSString *selectedLanguage = [YFCulture getPreferredLanguage];
...
+ (BOOL)isChinese
{
    return ([[YFCulture getPreferredLanguage] isEqualToString:kLMChinese] || [[YFCulture getPreferredLanguage] isEqualToString:kLMChinese2])?YES:NO;
}
