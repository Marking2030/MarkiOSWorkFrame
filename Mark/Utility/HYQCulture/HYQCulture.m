...
+ (NSString *)localizedString:(NSString *)key {
    ...
    NSString *selectedLanguage = [HYQCulture getPreferredLanguage];
...
+ (BOOL)isChinese
{
    return ([[HYQCulture getPreferredLanguage] isEqualToString:kLMChinese] || [[HYQCulture getPreferredLanguage] isEqualToString:kLMChinese2])?YES:NO;
}
